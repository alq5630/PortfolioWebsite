...
(function initESDWidget() {
    ...
    if (window.__esdWidgetInitialized) return;
    ...
    css.rel = "stylesheet";
    css.href = "assets/css/widget.css"; // Option A - your existing file
    ...
    const SUBTYPES = {
        ...
        B: {
            ...
            practice: "Slow exhale. Longer out than in. Remind yourself you do not have to hold everything."
        },
        ...
        D: {
            ...
            teaching: "You may flip between intense caring and sudden shutdowns...",
            practice: "Ask: 'Am I closer to flooded or numb right now? What is a 1 percent softer step?'"
        },

        E: {
            id: "E",
            name: "Type E · Empathic Shutdown",
        ...
        F: {
            id: "F",
            name: "Type F · Dark Empathy (Strategic)",
    ...
    const STEPS = [
        {
            ...
            options: [
                ...
                {
                    id: "strategic",
                    label: "In my head and managing the situation",
                    adds: { C: 1, F: 0.5 },
        ...
        },
        {
            ...
            options: [
                {
                    id: "body_amp",
                    label: "Fast heartbeat / tight chest",
                    adds: { B: 1, D: 0.5 },
                ...
                {
                    id: "mind_race",
                    label: "Racing thoughts about others",
                    adds: { B: 1, F: 0.5 },
                ...
                {
                    id: "analyze_mode",
                    label: "Analyzing more than feeling",
                    adds: { C: 1, A: 0.5 },
                    mini: "Classic Type C cognitive empathy."
                },

                {
                    id: "control_mode",
                    label: "Wanting to manage others' reactions",
                    adds: { F: 1, C: 0.5 },
        ...
        },
        {
            ...
            options: [
                {
                    id: "over_merged",
                    label: "Very merged; hard to tell what is mine",
                    adds: { B: 1, D: 0.5 },
                    mini: "Merging reflects soft boundaries and emotional labor."
                },

                {
                    id: "distant",
                    label: "I care but feel flat or far away",
                    adds: { A: 1, E: 0.5 },
                ...
                {
                    id: "observing",
                    label: "Observing more than feeling",
                    adds: { C: 1, A: 0.5 },
                    mini: "Clear understanding, quieter emotion - Type C."
                },

                {
                    id: "swinging",
                    label: "Swinging between caring and shutting down",
                    adds: { D: 1, B: 0.5, E: 0.5 },
                    mini: "Oscillation reflects stress on your window of tolerance."
                },

                {
                    id: "selective",
                    label: "Empathic when it serves a goal",
                    adds: { F: 1, C: 0.5 },
                    mini: "Intentional attunement reflects strategic empathy."
                }
            ]
        }
    ];
    ...
    function computeScores() {
        ...
        STEPS.forEach(step => {
            ...
            const apply = id => {
                ...
                Object.entries(opt.adds).forEach(([k, v]) => {
                    totals[k] += v;
                });
            };
...
`;
        ...
        options.forEach(btn => {
            btn.addEventListener("click", () => {
                ...
                if (step.multi) {
                    const current = Array.isArray(state.answers[step.id])
                ...
                if (step.multi) {
                    ...
                    options.forEach(b => {
                        if (active.includes(b.dataset.id)) {
                ...
                // mini feedback
                mini.style.display = opt && opt.mini ? "block" : "none";
                mini.innerHTML = (opt && opt.mini) || "";
            });
        });
